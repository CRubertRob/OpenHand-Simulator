...
function handles = DrawContacts(contacts, friction, conelength, transparency, col)
...
handles = orEnvPlot(transpose(allpoints), 'color',col,'transparency',transparency,'trilist');
